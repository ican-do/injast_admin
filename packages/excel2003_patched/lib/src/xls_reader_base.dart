      ...
      switch (record.type) {
        ...
        case BiffRecordType.sst:
          ...
          sstChunks
            ...
            ..add(record.data);
          break;
        case BiffRecordType.continueRec:
          if (collectingSst) sstChunks.add(record.data);
          break;
        case BiffRecordType.eof:
          if (collectingSst && sstChunks.isNotEmpty) {
            _sst.parseMergedSst(sstChunks);
          }
          return;
        default:
          if (collectingSst && sstChunks.isNotEmpty) {
