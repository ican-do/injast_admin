  ...
  List<Widget> _buildCategorySections() {
    final sections = [
      ...
      BackupCategorySection(
        ...
        helpSteps: const [
          'پرونده‌ها: فایل را از سامانه اصناف ذخیره کنید (در اکسل: ذخیره به‌عنوان → سی‌اس‌وی با یو‌تی‌اف‌۸). '
              'ردیف‌های تکراری کد صنفی با قوانین وضعیت (فعال/صادر شده، ابطال، تاریخ صدور) یکتا می‌شوند. '
              'اگر پرونده روی سرور نباشد ثبت می‌شود؛ اگر باشد وضعیت، تاریخ صدور و تاریخ انقضا (صدور + ۵ سال) به‌روز می‌شود.',
